...
export function make(options: ClientOptions) {
  ...
  return {
    ...
    session: {
      ...
      mirror: (input: SessionMirrorInput, requestOptions?: RequestOptions) =>
        request<{ readonly data: SessionMirrorOutput }>(
          {
            method: "POST",
            path: `/api/experimental/session/mirror`,
            body: {
              info: input["info"],
            ...
            request<SessionInstructionsEntryPutOutput>(
              {
                ...
                successStatus: 204,
                declaredStatuses: [400, 401, 404, 409, 413],
                empty: true,
              },
              requestOptions,
            ),
